...
/// 数据库连接管理器.
/// </summary>
internal sealed class PodcastDatabase : ISqliteDatabase, IAsyncDisposable, IDisposable
{
    private readonly string _connectionString;
    private readonly ILogger<PodcastDatabase>? _logger;
    ...
    public PodcastDatabase(string databasePath, ILogger<PodcastDatabase>? logger = null)
    {
        // 禁用连接池以确保关闭连接后可以删除文件
    ...
    {
        _logger?.LogInformation("Initializing Podcast database...");
        ...
        _logger?.LogInformation("Podcast database initialized successfully.");
    }
